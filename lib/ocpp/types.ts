...
export type OcppCallResult = [typeof CALL_RESULT, string, Record<string, unknown>]
export type OcppCallError = [typeof CALL_ERROR, string, string, string, Record<string, unknown>]
...
export interface BootNotificationRequest {
  ...
  reason: "PowerUp" | "ApplicationReset" | "FirmwareUpdate" | "RemoteReset" | "Triggered" | "Unknown" | "Watchdog"
}
...
export interface AuthorizeResponse {
  idTokenInfo: {
    status: "Accepted" | "Blocked" | "Expired" | "Invalid" | "NoCredit" | "NotAllowedTypeEVSE" | "NotAtThisLocation" | "NotAtThisTime" | "Unknown"
  }
}
